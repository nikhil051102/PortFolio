...
const ProjectSection = () => {
  ...
  return (
    <div className="bg-black text-white shadow-2xl shadow-black">
      ...
      <div class="p-6 pt-3 justify-center flex">
        <button
          class="block  w-50% select-none rounded-lg bg-white py-3.5 px-7 text-center align-middle font-sans text-sm font-bold uppercase text-black shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
          type="button"
        >
          View All Projects
        </button>
