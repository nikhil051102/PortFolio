...
const ContactMe = () => {
  return (
    <div className="bg-black text-white flex flex-wrap justify-evenly">
      {/* left side */}
        ...
        <form className="flex flex-col items-end">
          <div className="mb-4">
            ...
            <input
              ...
              className="border rounded py-2 px-3 w-[30rem] text-black font-medium"
            />
          </div>
          <div className="mb-4">
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              className="border rounded py-2 px-3 w-[30rem] h-28 text-black font-medium"
            />
          </div>
          <button
            type="submit"
